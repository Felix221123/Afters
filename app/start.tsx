  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>HOW BIG IS THE <span style={styles.partyText}>PARTY?</span></Text>
      </View>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: "#FAD63D", // Yellow background
    position: "relative",
  },
  titleContainer: {
    width: "100%",
  ...
  activeNumber: {
    color: "#B86FBE", // Purple for active number
  },
  inactiveNumber: {
    color: "#FFFFFF", // Light numbers
    opacity: 0.5,
  },
  actionButton: {
    marginTop: 50,
